...
DefaultGroupName=SmartPedal
OutputBaseFilename="SmartPedal-Win-##APPVERSION##"
OutputDir=.
LicenseFile=../../LICENSE.txt
SetupIconFile=../../resources/guitarml.ico
UninstallDisplayIcon=../../resources/SmartPedal.ico
...
[Files]
Source: "../../bin/Win64/SmartPedal.vst3"; DestDir: "{code:GetDir|VST3_64}"; Components: VST3_64; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "../../build-aax/SmartPedal_artefacts/Release/AAX/SmartPedal.aaxplugin"; DestDir: "{code:GetDir|AAX}"; Components: AAX; Flags: ignoreversion recursesubdirs createallsubdirs
